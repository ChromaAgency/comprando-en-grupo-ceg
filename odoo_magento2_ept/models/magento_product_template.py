...
class MagentoProductTemplate(models.Model):
    ...
    def open_variant_list(self):
        ...
        action = {
            ...
            'views': [(tree_view, 'list'), (form_view_id, 'form')],
            'view_id': tree_view,
            'target': 'current',
    ...
    def get_magento_attribute_set(product, product_type, is_it_child, attribute_set_id,
        ...
        if not attribute_set:
            ...
            log_line.create_common_log_line_ept(message=message, default_code=product.magento_sku, module='magento_ept',
    ...
    def get_scope_wise_product_price(instance, log_line, product, price_list, cost_price=False):
        ...
        if price_list:
            ...
            log_line.create_common_log_line_ept(message=message, module='magento_ept', magento_instance_id=instance.id)
        return product_price
    ...
    def export_attribute_in_magento(self, magento_att, line, conf_product_sku, instance, log_line):
        ...
        try:
            ...
            log_line.create_common_log_line_ept(message=message, module='magento_ept', default_code=conf_product_sku,
                                                operation_type='export', model_name='magento.product.template',
                                                magento_instance_id=instance.id)
            return True
    ...
    def export_product_attribute_in_magento(
        ...
        try:
            ...
            log_line.create_common_log_line_ept(message=message, module='magento_ept', default_code=sku,
                                                operation_type='export', model_name='magento.product.template',
                                                magento_instance_id=instance.id)
    ...
    def assign_attribute_in_attribute_set(self, instance, product, attribute_set_id,
        ...
        try:
            ...
            log_line.create_common_log_line_ept(message=message, module='magento_ept', default_code=product.magento_sku,
                                                operation_type='export', model_name='magento.product.template',
                                                magento_instance_id=instance.id)
            return True
        return False
    ...
    def bind_simple_with_configurable_product(
        ...
        for product_magento_sku in product_magento_sku_list:
            try:
                ...
                """
                log_line.create_common_log_line_ept(message=message, module='magento_ept', default_code=product_magento_sku,
                                                    operation_type='export', model_name='magento.product.template',
                                                    magento_instance_id=instance.id)
        return True
